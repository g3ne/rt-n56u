...
CPP="/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2 -E"
...
CPPFLAGS=""
LDFLAGS="-L/opt/rt-n56u/trunk/stage/lib -Wl,--gc-sections -Wl,--gc-sections -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -pie"
